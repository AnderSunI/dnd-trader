...
# ============================================================
# update-itemstat.py
# Скрипт для точечного обновления / дозагрузки тестовых предметов
# и услуг без полного пересоздания БД.
#
# Что умеет:
# - обновлять существующие предметы по name
# - при желании создавать отсутствующие предметы
# - использовать встроенный словарь тестовых предметов
# - опционально читать внешний JSON-файл
# ============================================================
