...
def serialize_user(user: User) -> dict:
    ...
    return {
        ...
        "showcase_text": user.showcase_text or "",
        "preferred_role": user.preferred_role or "player",
        "timezone": user.timezone or "UTC",
        "locale": user.locale or "ru-RU",
        "privacy_level": user.privacy_level or "public",
        "allow_friend_requests": bool(user.allow_friend_requests),
        "allow_party_invites": bool(user.allow_party_invites),
        "allow_profile_view_public": bool(user.allow_profile_view_public),
        "allow_direct_messages": user.allow_direct_messages or "friends",
        "show_gm_badge": bool(user.show_gm_badge),
        "profile_tags": user.profile_tags or [],
        "preferred_systems": user.preferred_systems or [],
        "featured_item_ids": user.featured_item_ids or [],
